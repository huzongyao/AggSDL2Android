...
namespace agg {
    ...
    bool platform_support::init(unsigned width, unsigned height, unsigned flags) {
        ...
        m_specific->m_surface = SDL_CreateRGBSurface(0, width, height, m_bpp,
                                                     m_specific->m_rmask,
                                                     m_specific->m_gmask,
                                                     m_specific->m_bmask,
                                                     m_specific->m_amask);
    ...
    void platform_support::update_window() {
        SDL_UpdateTexture(m_specific->m_texture, NULL, m_specific->m_surface->pixels,
                          m_specific->m_surface->pitch);
