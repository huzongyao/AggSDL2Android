...
#ifdef __ANDROID__
        width = (unsigned int) Android_SurfaceWidth;
        height = (unsigned int) Android_SurfaceHeight;
#endif
            ...
            if (ev_flag) {
                ...
                switch (event.type) {
                    ...
                    case SDL_MOUSEBUTTONDOWN:
                        ...
                        DEBUG_PRINT("Mouse Down: [%dx%d, %d]", m_specific->m_cur_x,
                                    m_specific->m_cur_y, flags);
                        break;
                    case SDL_MOUSEBUTTONUP:
                        ...
                        DEBUG_PRINT("Mouse Up: [%dx%d, %d]", m_specific->m_cur_x,
                                    m_specific->m_cur_y, flags);
                        break;
                    case SDL_FINGERDOWN:
